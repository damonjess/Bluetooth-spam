...
@Entity(
    indices = [
        androidx.room.Index(value = ["advertiseSettingsId"]),
        androidx.room.Index(value = ["advertisingSetParametersId"]),
        androidx.room.Index(value = ["advertiseDataId"]),
        androidx.room.Index(value = ["scanResponseId"]),
        androidx.room.Index(value = ["periodicAdvertisingParametersId"]),
        androidx.room.Index(value = ["periodicAdvertiseDataId"])
    ]
)
